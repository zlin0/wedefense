# The original version is from https://github.com/TakHemlata/RawBoost-antispoofing/blob/main/data_utils_rawboost.py
...
# Author: Hemlata Tak, Madhu Kamble, Jose Patino, Massimiliano Todisco and Nicholas Evans
...
# Raeboost contain too many parameters, and we usually use the default configuration.
...
def debug():
    ...
    wav_path='/export/fs05/lzhan268/workspace/PUBLIC/PartialSpoof/database/train/con_wav/CON_T_0000000.wav'    
